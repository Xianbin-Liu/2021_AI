...
def readtestfile(filename, vocab, idf_vector):
...
def main():
    ...
    test_file = 'classification_simple_test.csv'
...
#    ks = [1,2,3,5,10,15,20]
    ...
    with open(file='/Users/liuxb/2021_au/al_rao/lab/lab1/result/classification_simple_test.csv', mode='wb') as f:
        df = pandas.DataFrame()
